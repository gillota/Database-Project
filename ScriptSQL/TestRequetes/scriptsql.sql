...
/*Refuge propose tel typerepas*/
CREATE TABLE Propose
(
    EmailRefuge VARCHAR(50) NOT NULL,
    TypeRepas VARCHAR(10) NOT NULL CHECK (TypeRepas IN ('Dejeuner','Diner','Souper','CasseCroute')),
...
(
    MarqueMatLot VARCHAR(20) NOT NULL,
    ModeleMatLot VARCHAR(20) NOT NULL,
